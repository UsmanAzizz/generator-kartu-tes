...
infoTable: { 
      ...
      fontWeight: 'bold', 
      width: '100%',
      textAlign: 'left', // Memastikan semua teks rata kiri
      borderCollapse: 'collapse', // Menghilangkan celah antar sel tabel
      marginLeft: '2mm' // Memberikan sedikit jarak dari foto agar tidak terlalu mepet
    },
    footerArea: {
      marginTop: 'auto',
      textAlign: 'right',
