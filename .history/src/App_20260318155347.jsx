...
const styles = {
    ...
    page: {
      ...
      display: 'grid',
      // Membagi 210mm jadi 2 kolom: @105mm pas
      gridTemplateColumns: '105mm 105mm', 
      // Membagi 330mm jadi 4 baris: @82.5mm pas
      gridTemplateRows: '82.5mm 82.5mm 82.5mm 82.5mm',
      boxSizing: 'border-box',
      boxShadow: '0 0 20px rgba(0,0,0,0.5)',
      overflow: 'hidden',
      border: 'none'
    },
    // SLOT JADI TEMPAT GARIS POTONG
    cardSlot: (index) => ({
      boxSizing: 'border-box',
      height: '82.5mm',
      width: '105mm',
      padding: '0', 
      margin: '0',
      display: 'block', // Pakai block supaya card 100% tidak lari
      // Garis potong tengah vertikal & horizontal
      borderRight: (index % 2 === 0) ? '0.4mm dashed #888' : 'none', 
      borderBottom: (index < 6) ? '0.4mm dashed #888' : 'none',
      position: 'relative'
    }),
    card: {
      width: '100%', 
      height: '100%', 
      backgroundColor: 'white',
      // Padding ini untuk jaga konten di dalam agar tidak kena potong cutter
      padding: '0mm 6mm 6mm 6mm', 
      boxSizing: 'border-box',
      display: 'flex',
      flexDirection: 'column',
      position: 'relative',
      borderRadius: '0', // Siku sempurna agar mepet garis
      border: 'none',
      boxShadow: 'none'
    },
    headerKop: { width: '100%', marginBottom: '6px' },
    titleSection: { textAlign: 'center', marginBottom: '8px' },
    titleText: { fontSize: '10pt', fontWeight: 'bold', margin: '0', lineHeight: '1.2' },
    ...
    infoTable: { fontSize: '10pt', fontWeight: 'bold', width: '100%', borderCollapse: 'collapse' },
    footerArea: {
      marginTop: 'auto',
      textAlign: 'right',
      fontSize: '9pt',
    ...
    signature: { fontWeight: 'bold', textDecoration: 'underline', marginTop: '10mm', fontSize: '10pt' },
    btnDownload: {
