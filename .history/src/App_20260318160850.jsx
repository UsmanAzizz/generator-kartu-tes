...
function App() {
  ...
  <tbody>
    <tr>
      {/* BERI JARAK KE KANAN (paddingRight) */}
      <td style={{ padding: '1px 15px 1px 0', width: '65px' }}>Nama</td>
      <td style={{ padding: '1px 0' }}>:</td>
      {/* BERI JARAK KE KIRI (paddingLeft) */}
      <td style={{ padding: '1px 0 1px 8px' }}>{std.nama}</td>
    </tr>
    <tr>
      <td style={{ padding: '1px 15px 1px 0' }}>Kelas</td>
      <td>:</td>
      <td style={{ padding: '1px 0 1px 8px' }}>{std.kelas}</td>
    </tr>
    <tr>
      <td style={{ padding: '1px 15px 1px 0' }}>Username</td>
      <td>:</td>
      <td style={{ padding: '1px 0 1px 8px' }}>{std.username}</td>
    </tr>
    <tr>
      <td style={{ padding: '1px 15px 1px 0' }}>Password</td>
      <td>:</td>
      <td style={{ padding: '1px 0 1px 8px' }}>{std.password}</td>
    </tr>
  </tbody>
</table>
                  </div>
