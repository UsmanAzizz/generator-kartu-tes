...
// Pastikan file ini ada di folder src Anda
...
function App() {
  ...
  const styles = {
    // Wrapper dikunci agar tidak ada scroll body
    wrapper: { 
      backgroundColor: '#525659', 
      height: '100vh', 
      width: '100vw',
      fontFamily: 'Arial, sans-serif',
      overflow: 'hidden', // Menghilangkan scrollbar utama
      display: 'flex',
      flexDirection: 'column'
    },
    // Area scroll internal agar user bisa melihat kartu tanpa scrollbar browser
    scrollContainer: {
      flex: 1,
    ...
    cardSlot: (index) => ({
      ...
      height: '100%',
      width: '100%',
      // Garis putus-putus bantu potong
    ...
    signature: { fontWeight: 'bold', marginTop: '12mm' },
    btnDownload: {
      position: 'fixed', top: '20px', right: '40px', padding: '12px 24px',
  ...
  const pages = chunkData(students, 8); // 8 kartu per halaman F4 (2x4)
                  ...
                  <div style={styles.card}>
                    ...
                    <div style={styles.mainContent}>
                      ...
                      <table style={styles.infoTable}>
                        <tbody>
                          <tr><td width="55">Nama</td><td width="10">:</td><td><strong>{std.nama}</strong></td></tr>
