  ...
  const downloadTemplate = () => {
    const data = [
      { Nama: "ALYA JESIKA", Kelas: "X AKL", No_Pst: "2025/UKK/101" }, // Header adalah No_Pst
    ];
    ...
    return (
      <div style={styles.wrapper}>
        ...
        <div style={styles.sidebar}>
          <h3 style={{margin: '0 0 10px 0'}}>MALES BANGET BIKIN KARTU MANUAL</h3>
          
         {/* 1. DOWNLOAD TEMPLATE */}
  <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
    <label style={{ fontSize: '11px', color: '#bdc3c7' }}>1. Format Data</label>
    <button style={styles.sideBtn} onClick={downloadTemplate}>
  ...
  <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
    ...
    <small style={{ fontSize: '9px', color: '#ecf0f1', marginTop: '2px' }}>
      *Nama file harus sama dengan Nama Siswa
    </small>
  </div>
